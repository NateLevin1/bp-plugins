...
/**
 * This code is taken entirely from the BungeeCord GitHub page: https://github.com/SpigotMC/BungeeCord/blob/master/proxy/src/main/java/net/md_5/bungee/BungeeTitle.java
 * Why this is not included in BungeeCord is beyond me. All I changed was that I removed the lombok.Data requirement
 */
...
public class BungeeTitle implements Title {
    ...
    private static class TitlePacketHolder<T extends DefinedPacket> {
        ...
        TitlePacketHolder(net.md_5.bungee.protocol.packet.Title oldPacket, T newPacket) {
