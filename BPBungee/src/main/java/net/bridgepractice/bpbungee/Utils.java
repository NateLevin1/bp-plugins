...
public class Utils {
    ...
    public static void sendWarnWebhook(String reason, ProxiedPlayer staff, String warnedName, CommandSender playerToSendErrorsTo) {
        ...
        embed.addProperty("color", Integer.valueOf(50574));
   ...
   public static String getGameModeName(MultiplayerMode mode) {
    ...
    public static void log(BaseComponent[] components, String permission) {
        broadcastToPermission(permission, (new ComponentBuilder("|||")).color(ChatColor.DARK_AQUA).obfuscated(true).append(" ").obfuscated(false).appendLegacy("").append(components).create());
    }
